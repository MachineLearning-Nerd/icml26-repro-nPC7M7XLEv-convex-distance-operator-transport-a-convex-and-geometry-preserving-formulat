...
under all three outer seeds. This child adds the exact-scale, 100-trial
synthetic Claim 3 reproduction. All formal compute uses Hugging Face
`cpu-upgrade`; no GPU is used.

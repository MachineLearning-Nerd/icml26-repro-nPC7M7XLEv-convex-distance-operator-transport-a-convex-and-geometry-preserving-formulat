# CURRENT — Claim 5: TUDataset graph classification

---
<!-- trackio-cell
{"type":"markdown","id":"cell_current_claim_5","created_at":"2026-07-29T04:00:00+00:00","title":"CURRENT \u2014 Claim 5: TUDataset graph classification","pinned":true,"pinned_at":"2026-07-29T04:00:00+00:00"}
-->
...
- [Primary verifier](../../current/code/claim5.py)
- [Independent checker](../../current/code/claim5_checker.py)
- [Cumulative nonzero-exit runner](../../current/code/run.py)

### Raw machine-readable evidence

- [claim_5_independent_checker.json](../../current/evidence/claim_5/raw/claim_5_independent_checker.json)
- [claim_5_nested_cv_rows.json](../../current/evidence/claim_5/raw/claim_5_nested_cv_rows.json)
- [claim_5_permuted_controls.json](../../current/evidence/claim_5/raw/claim_5_permuted_controls.json)
- [claim_5_result.json](../../current/evidence/claim_5/raw/claim_5_result.json)
- [claim_5_selected_pair_diagnostics.json](../../current/evidence/claim_5/raw/claim_5_selected_pair_diagnostics.json)
- [materialization_manifest.json](../../current/evidence/claim_5/raw/materialization_manifest.json)
...
- [EVAL.md](../../current/evidence/claim_5/EVAL.md)
- [claim_contract.json](../../current/evidence/claim_5/claim_contract.json)
- [limitations.md](../../current/evidence/claim_5/limitations.md)
- [method.md](../../current/evidence/claim_5/method.md)
- [source_audit.md](../../current/evidence/claim_5/source_audit.md)

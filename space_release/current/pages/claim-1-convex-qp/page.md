...
Raw result:
[`claim_1_result.json`](../../evidence/claim_1/raw/claim_1_result.json).
...
- [Primary verifier](../../code/claim1.py)
- [Independent checker](../../code/claim1_checker.py)
...
- [EVAL.md](../../evidence/claim_1/EVAL.md)
- [claim_contract.json](../../evidence/claim_1/claim_contract.json)
- [limitations.md](../../evidence/claim_1/limitations.md)
- [method.md](../../evidence/claim_1/method.md)
- [proof_certificate.md](../../evidence/claim_1/proof_certificate.md)
- [source_audit.md](../../evidence/claim_1/source_audit.md)
